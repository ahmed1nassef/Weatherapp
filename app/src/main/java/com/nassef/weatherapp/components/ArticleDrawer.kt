...
private fun AppDrawer(
    ...
    Surface(color = MaterialTheme.colorScheme.background) {
        Column(modifier = modifier.fillMaxSize()) {
            DrawerHeader()
            DrawerButton(
                painter = painterResource(id = R.drawable.article_icon),
            ...
            NavigationDrawerItem(
                ...
                selected = currentRoute == WeatherDestinations.SETTINGS_SCREEN_ROUTE,
                onClick = {
                    navController.navigate(WeatherDestinations.SETTINGS_SCREEN_ROUTE)
                    closeDrawer()
                },
                icon = {
                    Icon(
...
fun PreviewAppDrawer() {
    WeatherAppTheme {
        Surface {
            /*AppDrawer(
                currentRoute = WeatherDestinations.ARTICLE_MAIN_ROUTE,
                navigateToTasks = {},
                navigateToStatistics = {},
                closeDrawer = {}
            )*/
